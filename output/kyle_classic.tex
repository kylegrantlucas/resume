...
\section{Experience}
  \resumeSubHeadingListStart
	  \resumeSubheading
	    {Fender Musical Instruments}{Hollywood, CA}
	    {Senior Software Engineer}{2019-05-06 - 2020-05-15}
	    \resumeItemListStart
	      \companyItem
	  ...
	  \resumeSubheading
	    {i.am+}{Hollywood, CA}
	    {Software Engineering Manager}{2018-10-01 - 2019-05-04}
	    \resumeItemListStart
	      \companyItem
	  ...
	  \resumeSubheading
	    {i.am+}{Hollywood, CA}
	    {Senior Software Engineer}{2016-08-22 - 2019-05-04}
	    \resumeItemListStart
	      \companyItem
	      ...
	      \companyItem
	        {Designed a fast automated pipeline to ingest of GBs of nightly music data}
	      \companyItem
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Computer Science (Incomplete)}{2011-09-15 - 2015-02-01}
...
\section{Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Development}{: Golang, Ruby, Bash, Postgresql, Elasticsearch, Neo4j, Redis, InfluxDB}
      \hfill
    }
    \item{
      \textbf{Tooling}{: Docker, Kubernetes, Prometheus, Traefik, Grafana, Helm, Spinnaker}
      \hfill
    }
  \resumeSubHeadingListEnd
